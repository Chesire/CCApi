 ...
 */
abstract class JwtException(message: String, cause: Throwable? = null) : RuntimeException(message, cause)

/**
 * Thrown when JWT system configuration is invalid (e.g., bad secret key)
 * Results in HTTP 500 - Internal Server Error
 */
class JwtConfigurationException(message: String, cause: Throwable? = null) : JwtException(message, cause)
